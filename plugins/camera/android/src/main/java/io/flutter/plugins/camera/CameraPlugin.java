    ...
    public void onMethodCall(MethodCall call, final Result result) {
        switch (call.method) {
            ...
            case "setFlashMode": {
                ...
                boolean success = camera.setFlashMode(flashMode);
                result.success(success);
                break;
            }

            case "isFlashSupported": {
                final boolean isFlashSupported = camera.isFlashSupported();
                result.success(isFlashSupported);
                break;
            }
            default:
                    ...
                    .setStreamHandler(
                            new EventChannel.StreamHandler() {
                                ...
                                public void onListen(Object arguments, EventChannel.EventSink eventSink) {
                                    CameraPlugin.Camera.this.eventSink = eventSink;
                                }

                                @Override
                                public void onCancel(Object arguments) {
                                    CameraPlugin.Camera.this.eventSink = null;
                                }
                            });
        }
                    ...
                    cameraManager.openCamera(
                            ...
                            new CameraDevice.StateCallback() {
                                ...
                                public void onOpened(@NonNull CameraDevice cameraDevice) {
                                    CameraPlugin.Camera.this.cameraDevice = cameraDevice;
                                    try {
                                        startPreview();
                                    } catch (CameraAccessException e) {
                                        if (result != null)
                                            result.error("CameraAccess", e.getMessage(), null);
                                        cameraDevice.close();
                                        CameraPlugin.Camera.this.cameraDevice = null;
                                        return;
                                    }
                        ...
                        new CameraCaptureSession.StateCallback() {
                            ...
                            public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                                try {
                                    ...
                                    CameraPlugin.Camera.this.cameraCaptureSession = cameraCaptureSession;
